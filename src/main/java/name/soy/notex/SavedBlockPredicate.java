...
public class SavedBlockPredicate implements Predicate<CachedBlockPosition> {
	...
	@Override
	public String toString() {
		return "SavedBlockPredicate:" + conds;
	}
		...
		for (int i = 0; i < list.size(); i++) {
			...
			switch (nbt.getString("type")) {
				...
				case "in":
					...
					break;
				case "material":
					conds.add(new MaterialCondition(Registry.BLOCK.get(new Identifier(data))));
					break;
			}
		}
